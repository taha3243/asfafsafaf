  ...
  const strigalog = new Discord.MessageEmbed()
    ...
    .setDescription(
      "**<a:fors34:778005711509913621> Hoşgeldin! <@" +
        ...
        kontrol +
        "\n\n <a:fors37:778005711354462209> Tagımızı alarak ` 少 ` bize destek olabilirsin.** <a:fors37:778005711354462209> \n"
    )
    .setImage(
      "https://cdn.discordapp.com/attachments/755067604929871895/781597529690996746/fors2.gif"
    );
...
////////////////////////////////
client.on("ready", () => {
  client.channels.get("779032192021037116").join();
